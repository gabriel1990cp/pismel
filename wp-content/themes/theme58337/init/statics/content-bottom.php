 ...
 */
class theme58337_content_bottom extends cherry_register_static {
	...
	public function callback() {
		cherry_get_sidebar( "content-bottom" );
	}
}
 ...
 */
new theme58337_content_bottom(
	array(
		'name'    => __( 'Content bottom', 'child-theme-domain' ),
		'id'      => 'content_bottom',
		'options' => array(
			...
			'area'     => 'content-bottom', // (required) ID for static area
